...
/**
 * Politicadeseguridad generated by hbm2java
 */
public class Politicadeseguridad  implements java.io.Serializable {
    ...
    public Politicadeseguridad(int idpolitica, String signosespeciales, Integer longclavemin, Boolean contienedigito, Boolean igualaanterior, Set claves) {
       this.idpolitica = idpolitica;
